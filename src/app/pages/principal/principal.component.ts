...
@Component({
  ...
  standalone: true,
  imports: [LottieComponent,AnimateOnScrollDirective ,HeaderComponent, NgFor,DownloadButtonComponent, AboutmeComponent, ProjetsLigneComponent, ProjectpresentationComponent, ContactMeComponent],
...
export class PrincipalComponent implements OnInit, OnDestroy {
  ...
  buttonCV: button = new button("Télécharger mon CV", "assets/CV.pdf", "assets/svg/download.svg", "CV.pdf")
  projects: projet[] = [];
  private projectsSubscription: Subscription | undefined;
  categorie = ['home', 'about', 'portfolio', 'contact'];
  
  private isNavigating = false;
  private scrollTimeout: any;
  private navigationSubscription: Subscription | undefined;

  constructor(private router: Router, private projetsService: ProjetsService, private navigationService: NavigationService, private projectService: ProjetsService) { }

  ngOnInit() {
    this.projectsSubscription = this.projetsService.getProjects().subscribe(projects => {
